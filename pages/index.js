...
export default function Home() {
  return (
    ...
    <div class="cart-off">
            <div id="navigation2" class=" bestwishes2020">
                    ...
                    <div class="w-100 z-index-200 navigation-holder d-flex flex-column colored-transparent">
                        <div class="pt-20 pb-20 pl-15 pr-15 pr-40-sm pl-40-sm d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center"><a data-v-d95ab4c8="" href="/" class="mr-40-sm mr-10"><svg data-v-d95ab4c8="" width="150" height="30" viewBox="0 0 150 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="d-none d-sm-block">
                                    ...
                                    </svg> <svg data-v-d95ab4c8="" width="100" height="20" viewBox="0 0 100 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="d-block d-sm-none">
                            ...
                            <div class="align-items-center d-none d-xl-flex pl-30-md">
                                <div class="position-relative d-none d-xl-block" material="storefront">
                                    <div data-qa="online-stores-menu" class="navigation-color mr-30 cursor-pointer hover-opacity-6 fw-600"><a href="/loja-virtual" class="fs-15 fs-17-xxl">Loja Virtual</a></div>
                                    
                                </div>
                                <div class="position-relative d-none d-xl-block" material="view_compact">
                                    <div data-qa="website-builder-menu" class="navigation-color mr-30 cursor-pointer hover-opacity-6 fw-600"><a href="/criar-um-site" class="fs-15 fs-17-xxl">Criador de Sites</a></div>
                                    
                                </div>
                                <div class="position-relative d-none d-xl-block" dropdown="true">
                                    <div data-qa="hosting-menu" class="navigation-color mr-30 cursor-pointer hover-opacity-6 fw-600">
                                        <p class="d-flex align-items-center fs-15 fs-17-xxl">
                                            Hospedagem
                                ...
                                <div class="position-relative d-none d-xl-block" dropdown="true">
                                    <div data-qa="vps-menu" class="navigation-color mr-30 cursor-pointer hover-opacity-6 fw-600">
                                        <p class="d-flex align-items-center fs-15 fs-17-xxl">
                                            VPS
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#1D1E20" width="24px" height="24px">
                                                <path d="M0 0h24v24H0V0z" fill="none"></path>
                                ...
                                <div class="position-relative d-none d-xl-block" dropdown="true">
                                    <div data-qa="domain-menu" class="navigation-color mr-30 cursor-pointer hover-opacity-6 fw-600">
                                        <p class="d-flex align-items-center fs-15 fs-17-xxl">
                                            Domínio
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#1D1E20" width="24px" height="24px">
                                                <path d="M0 0h24v24H0V0z" fill="none"></path>
                                ...
                                <div class="position-relative d-none d-xl-block" nameispricing="true" material="attach_money">
                                    <div data-qa="pricing-menu" class="navigation-color mr-30 cursor-pointer hover-opacity-6 fw-600"><a href="/precos" class="fs-15 fs-17-xxl">Preços</a></div>
                                    
                                </div> <a data-qa="login-menu" href="/cpanel-login" class="navigation-color ml-10 d-flex border-radius-round pl-20 pr-20 p-2 border-h-dark"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#1D1E20" width="24px" height="24px">
                                        <g fill="none">
                                    ...
                                    <p class="fs-15 ml-10 fw-600 fs-17-xxl">Entrar</p>
                                </a> <a data-qa="cart-menu" href="/cart" class="hover-opacity-6 d-flex ml-20 align-items-center navigation-color"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="24px" height="24px">
                                        <path d="M0 0h24v24H0V0z" fill="none"></path>
                                        <path d="M15.55 13c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.37-.66-.11-1.48-.87-1.48H5.21l-.94-2H1v2h2l3.6 7.59-1.35 2.44C4.52 15.37 5.48 17 7 17h12v-2H7l1.1-2h7.45zM6.16 6h12.15l-2.76 5H8.53L6.16 6zM7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"></path>
                                    </svg>
                                    <p class="fs-17 fw-600 ml-n2 d-none d-sm-block ml-10">Carrinho</p>
                                </a>
                            </div>
                            <div class="d-flex d-xl-none"><a data-qa="cart-menu" href="/cart" class="hover-opacity-6 d-flex ml-20 align-items-center navigation-color"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="24px" height="24px">
                                        <path d="M0 0h24v24H0V0z" fill="none"></path>
                                        <path d="M15.55 13c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.37-.66-.11-1.48-.87-1.48H5.21l-.94-2H1v2h2l3.6 7.59-1.35 2.44C4.52 15.37 5.48 17 7 17h12v-2H7l1.1-2h7.45zM6.16 6h12.15l-2.76 5H8.53L6.16 6zM7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"></path>
                                    </svg>
                                    <p class="fs-17 fw-600 ml-n2 d-none d-sm-block ml-10">Carrinho</p>
                                </a> <i class="hover-opacity-6 notranslate material-icons cursor-pointer navigation-color ml-10 ml-40-sm">menu</i></div>
                  ...
                  <div className="pricing-table-plan__padding pt-35 pb-40 h-100 d-flex justify-content-between flex-column">
                    ...
                    <div>
                      ...
                      <div onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-hostinger-single')" className="mt-5 text-center cursor-pointer text-h-primary fw-700 body pricing-table-see-additional-features-link">
                        <div className="pricing-table-see-additional-features-link-text-see d-none" id="hgrwordpress-hosting-pricing_table-click_here_to_see_all_features-">
                          <div className="d-flex justify-content-center align-items-center">
                            Veja todas as características <i className="material-icons notranslate"> keyboard_arrow_down </i></div>
                        </div><a onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-hostinger-single')" className="pricing-table-see-additional-features-link-text-hide text-h-primary fw-700" id="hgrwordpress-hosting-pricing_table-click_here_to_see_less_features-">
                          <div className="d-flex justify-content-center align-items-center">
                    ...
                    <div>
                      ...
                      <div onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-hostinger-business')" className="mt-5 text-center cursor-pointer text-h-primary fw-700 body pricing-table-see-additional-features-link">
                        <div className="pricing-table-see-additional-features-link-text-see d-none" id="hgrwordpress-hosting-pricing_table-click_here_to_see_all_features-">
                          <div className="d-flex justify-content-center align-items-center">
                            Veja todas as características <i className="material-icons notranslate"> keyboard_arrow_down </i></div>
                        </div><a onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-hostinger-business')" className="pricing-table-see-additional-features-link-text-hide text-h-primary fw-700" id="hgrwordpress-hosting-pricing_table-click_here_to_see_less_features-">
                          <div className="d-flex justify-content-center align-items-center">
                            Ver menos características <i className="material-icons notranslate"> keyboard_arrow_up </i></div>
                        </a>
                      </div>
                    ...
                    <div>
                      ...
                      <div onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-cloud-economy')" className="mt-5 text-center cursor-pointer text-h-primary fw-700 body pricing-table-see-additional-features-link">
                        <div className="pricing-table-see-additional-features-link-text-see d-none" id="hgrwordpress-hosting-pricing_table-click_here_to_see_all_features-">
                          <div className="d-flex justify-content-center align-items-center">
                            Veja todas as características <i className="material-icons notranslate"> keyboard_arrow_down </i></div>
                        </div><a onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-cloud-economy')" className="pricing-table-see-additional-features-link-text-hide text-h-primary fw-700" id="hgrwordpress-hosting-pricing_table-click_here_to_see_less_features-">
                          <div className="d-flex justify-content-center align-items-center">
                            Ver menos características <i className="material-icons notranslate"> keyboard_arrow_up </i></div>
                        </a>
                      </div>
                    ...
                    <div>
                      ...
                      <div onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-hostinger-premium')" className="mt-5 text-center cursor-pointer text-h-red fw-700 body pricing-table-see-additional-features-link">
                        <div className="pricing-table-see-additional-features-link-text-see d-none" id="hgrwordpress-hosting-pricing_table-click_here_to_see_all_features-">
                          <div className="d-flex justify-content-center align-items-center">
                            Veja todas as características <i className="material-icons notranslate"> keyboard_arrow_down </i></div>
                        </div><a onclick="scrollToTargetWithNavigationOffset('pricing-table-plan-hosting-wp-hostinger-premium')" className="pricing-table-see-additional-features-link-text-hide text-h-red fw-700" id="hgrwordpress-hosting-pricing_table-click_here_to_see_less_features-">
                          <div className="d-flex justify-content-center align-items-center">
                            Ver menos características <i className="material-icons notranslate"> keyboard_arrow_up </i></div>
                        </a>
                      </div>
              ...
              <div id="carouselTips" className="carousel slide" data-ride="carousel">
                <div className="carousel-inner p-15 d-flex align-items-center pt-20 pt-40-sm">
                  <div className="carousel-item active">
                    <div className="card border-0 border-radius-15 shadow wordpress-reviews-card m-auto"><img className="wordpress-reviews-quotes-image lazy-load-image lazy-loaded-src" data-src="assets/images/wordpress-hosting-2020/icons/icon-quotes-1ab20d20e2.svg" src="assets/images/wordpress-hosting-2020/icons/icon-quotes-1ab20d20e2.svg" />
